...
**Status:** ✅ v0.7.0 — à prova de falhas silenciosas: port fallback automático, single-instance guard, health check interno, file watcher do config, timeout em UNC, ícone de alerta, modo kiosk (F11)
